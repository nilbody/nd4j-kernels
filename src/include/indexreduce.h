...
public:
	...
	virtual __device__ IndexValue<T> op(IndexValue<T> val,T *extraParams);
	...
	virtual __device__ IndexValue<T> update(IndexValue<T> old,IndexValue<T> opOutput,T *extraParams);
	...
	virtual __device__ IndexValue<T> merge(IndexValue<T> f1, IndexValue<T> f2,T *extraParams);
	...
	virtual __device__ IndexValue<T> postProcess(IndexValue<T> reduction,int n,int xOffset,T *dx,int incx,T *extraParams,T *result);
	 ...
	 * @return
	 */
	virtual __device__ T op(IndexValue<T> d1,IndexValue<T> d2,T *extraParams);
	/**
	 *
	 * @param sPartialsRef
	 * @param tid
